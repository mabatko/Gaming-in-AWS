...
**TLDR:** This repository contains information on how I set up my gaming environment in AWS.
...
1. Steam stores game saves in cloud (at least my saves are). This is important if you want to terminate your instance and delete its disk in order to save as much money as possible.
...
When I launch my gaming instance, select following options:
...
- **Network settings:**
  ...
  - **Subnet:** Subnet you created as a pre-requisite. I you have more subnets, pick the one with cheapest spot instance.
